    ...
    return (
        <div className="text-center max-w-4xl mx-auto mb-12 pt-20 md:pt-24">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight px-4">
                Wake Up for <span className='text-blue-600'>Suhoor {text}</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4">
                <button
                    ...
                    className="w-full sm:w-auto px-6 py-2.5 bg-blue-600 text-white text-base rounded-lg hover:bg-blue-700 font-medium transition shadow-lg hover:shadow-xl"
                >
                    Get Started
                </button>
                <button
                    onClick={() => navigate('/books')}
                    className="w-full sm:w-auto px-6 py-2.5 bg-white border-2 border-blue-600 text-blue-600 text-base rounded-lg hover:bg-blue-50 font-medium transition"
                >
                    Learn More
                </button>
            </div>
