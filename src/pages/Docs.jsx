    ...
    const sections = [
        ...
        },
        {
            ...
            subsections: [
                ...
                { id: 'fasting', title: 'Fasting Times & Prompts', icon: <Clock size={14} />, desc: "A dedicated prompt appears every evening asking if you wish to fast the next day. If you agree, The location you give will be released to your group members 30 minutes before suhoor time and you can buzzed if you have'nt already woken up. If you choose no, your team members will be aware of this from your group's detail page." },
