    ...
    const sections = [
        ...
        },
        {
            ...
            subsections: [
                ...
                { id: 'groups', title: 'Group Management', icon: <Users size={14} />, desc: 'From this page you can join or create groups using unique keys. Within a group, you can monitor the status of members, see live locations during wake up windows (30 minutes before Suhoor), and manually "Buzz" members who are still sleeping.' },
                { id: 'fasting', title: 'Fasting Times & Prompts', icon: <Clock size={14} />, desc: "A prompt appears every evening asking if you wish to fast the next day. If you agree, Suhoor, as well as your group members will be able to wake you, the location you give will be released to your group members 30 minutes before suhoor time and you can be buzzed if you have'nt already woken up. If you choose no, your team members will be aware of this from your group's page. The prompt defaults to no on normal days but defaults to yes in three cases \n\n 1. Mondays and Thurdays \n\n 2. The 13th, 14th & 15th of every islamic month \n\n 3. All days of ramadan" },
